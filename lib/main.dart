...
void main() async {
  ...
  SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle.dark.copyWith(
    statusBarColor: Colors.white, // Set the status bar background to white
    statusBarIconBrightness:
        Brightness.dark, // Set the status bar icon color to dark
    statusBarBrightness:
        Brightness.light, // Set the status bar background brightness to light
  ));
  runApp(const MyApp());
}
